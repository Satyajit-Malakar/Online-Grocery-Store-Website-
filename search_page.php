...
<section class="search-form">
   ...
   <form action="" method="POST">
      <input type="text" placeholder="Search for products..." list="list_iteam" class="box" name="search_box" style="border-radius: 15px; border: 1px solid #ccc; padding: 10px;">
      <!-- <datalist id="list_iteam">
        <option value="Fish"></option>
        <option value="Mango"></option>
        <option value="Apple"></option>
      </datalist> -->
      <!-- <button type="submit" name="search_btn" style="background-color: #4CAF50; color: white; padding: 10px 20px; border: none; border-radius: 15px; cursor: pointer; font-size: 16px;">Search</button> -->
      <button type="submit" name="search_btn" style="background-color: #4CAF50; color: white; padding: 10px 20px; border: none; border-radius: 15px; cursor: pointer; font-size: 16px;">
...
<section class="products" style="padding-top: 0; min-height:100vh;">
   ...
   <?php
      if(isset($_POST['search_btn']) or $search != ''){
