...
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      ...
      <?php if ($fetch_wishlist['is_available']): ?>
      ...
      <div style="text-align: center;">
         ...
         <input type="submit" value="Add to Cart" class="btn <?php if(!$fetch_wishlist['is_available']) echo 'disabled-btn'; ?>" name="add_to_cart" style="display: block; width: 80%; margin: 10px auto; font-size: 1.8rem;" <?php if(!$fetch_wishlist['is_available']) echo 'disabled'; ?>>
      </div>
   </form>
   <?php
